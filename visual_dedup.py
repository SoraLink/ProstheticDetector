...
# ================= 配置区域 =================
# 请替换为你实际的文件夹路径
DIR_CRAWLER = "/DATA/knee"  # 待清洗的爬虫数据
DIR_TRAIN = "./dataset_prosthetic_separated/train/knee"  # 训练集
DIR_VAL = "./dataset_prosthetic_separated/val/knee"  # 验证集
DIR_TEST = "./dataset_prosthetic_separated/test/knee"  # 测试集
